...
const AccountAvatar = () => {
  ...
  const handleRemoveAvatar = () => {
    ...
    updateAccount({avatar: null}, dispatch, setWaitingProccess);
  }
  ...
  useEffect(() => {
    if (!isInitialRender) {
      validateData(() => {
        setWaitingProccess(true);
        updateAccountAvatar(avatarData, dispatch, setWaitingProccess);
      });
      setIsInitialRender(true);
    }
  }, [validateData, avatarData, isInitialRender, dispatch]);
